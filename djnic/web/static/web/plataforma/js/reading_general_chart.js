...
function drawChart1() {
    ...
    var jsonData = $.ajax({
        url: "/api/v1/dominios/stats/general?p=1",
        dataType: "json",
        async: false
        });
    ...
    var materialOptions = {
        chart: {title: 'Lectura de dominios por hora'}}
    ...
    var materialOptions = {
        chart: {title: 'Lectura de dominios por día'}}
    ...
    var materialOptions = {
        chart: {title: 'Lectura de dominios por semana'}}
